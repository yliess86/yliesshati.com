...
export default function Hero() {
  return (
    <header>
      <Card className="flex flex-col justify-center md:flex-row text-center md:text-left gap-6">
        ...
        <div className="flex flex-col justify-between flex-1 gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 bottom-0">
            ...
            <a className="px-4 py-2 bg-black text-white rounded-sm" href="mailto:yliess.hati@devinci.fr">Available for Hire</a>
          </div>
        </div>
      </Card>
    </header>
